  ...
  return (
    <AppShell>
      <PageHeading
        ...
        action={<div className="flex flex-col gap-2 sm:flex-row"><DownloadExcelButton /><Link href="/viajes/nuevo" className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-800"><Plus className="size-4" aria-hidden="true" />Nuevo viaje</Link></div>}
      />
